        ...
        <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
          <Grid container spacing={{ xs: 8, md: 12 }}>
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              >
                The Williams Uchemba Foundation is dedicated to addressing
                systemic poverty and social inequality through strategic
                intervention, sustainable development, and a radical commitment
                to transparency.
              </Typography>
